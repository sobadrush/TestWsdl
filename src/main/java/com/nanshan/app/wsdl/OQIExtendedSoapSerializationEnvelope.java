...
class OQISoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class OQIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://WebXml.com.cn/^^ArrayOfString",OQIArrayOfString.class);
    } 
    ...
    public static void setDateTimeConverter(OQIDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new OQIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OQIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OQIDateTimeConverter dateTimeConverter = new OQIStandardDateTimeConverter();

    public OQIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OQIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OQIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OQIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OQIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OQIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
